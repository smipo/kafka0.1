...
import kafka.clients.producer.ProducerInterceptor;
...
public class ProducerInterceptorsTest {
    private final TopicPartition tp = new TopicPartition("kafka/test", 0);
    private final ProducerRecord<Integer, String> producerRecord = new ProducerRecord<>("kafka/test", 0, 1, "value");
