...
import kafka.common.requests.ProduceResponse;
...
public class SenderTest {
    ...
    private TopicPartition tp = new TopicPartition("kafka/test", 0);
    private MockTime time = new MockTime();
    private MockClient client = new MockClient(time);
    private int batchSize = 16 * 1024;
    private Metadata metadata = new Metadata(0, Long.MAX_VALUE, true, new ClusterResourceListeners());
    private Cluster cluster = TestUtils.singletonCluster("kafka/test", 1);
    ...
    public void testSendInOrder() throws Exception {
        ...
        try {
            ...
            Cluster cluster1 = TestUtils.clusterWith(2, "kafka/test", 2);
            metadata.update(cluster1, time.milliseconds());

            // Send the first message.
            TopicPartition tp2 = new TopicPartition("kafka/test", 1);
            ...
            Cluster cluster2 = TestUtils.singletonCluster("kafka/test", 2);
