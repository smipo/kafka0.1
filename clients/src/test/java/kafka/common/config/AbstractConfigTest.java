...
import kafka.common.config.ConfigDef.Importance;
import kafka.common.config.ConfigDef.Type;
import kafka.common.metrics.FakeMetricsReporter;
...
public class AbstractConfigTest {
    ...
    public void testConfiguredInstances() {
        testValidInputs("");
        testValidInputs("kafka.common.metrics.FakeMetricsReporter");
        testValidInputs("kafka.common.metrics.FakeMetricsReporter, kafka.common.metrics.FakeMetricsReporter");
        testInvalidInputs(",");
        testInvalidInputs("kafka.clients.producer.unknown-metrics-reporter");
        testInvalidInputs("test1,test2");
        testInvalidInputs("kafka.common.metrics.FakeMetricsReporter,");
    }
    ...
    public void testUnused() {
        Properties props = new Properties();
        String configValue = "kafka.common.config.AbstractConfigTest$ConfiguredFakeMetricsReporter";
