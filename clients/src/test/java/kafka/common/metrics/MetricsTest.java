...
import kafka.common.metrics.stats.SimpleRate;
...
public class MetricsTest {
    ...
    public void testDuplicateMetricName() {
        metrics.sensor("kafka/test").add(metrics.metricName("kafka/test", "grp1"), new Avg());
        metrics.sensor("test2").add(metrics.metricName("kafka/test", "grp1"), new Total());
    }

    @Test
    public void testQuotas() {
        Sensor sensor = metrics.sensor("kafka/test");
    ...
    public void testPercentiles() {
        ...
        Sensor sensor = metrics.sensor("kafka/test", config);
        sensor.add(percs);
