...
import kafka.clients.ClientResponse;
import kafka.clients.Metadata;
import kafka.clients.consumer.ConsumerRecord;
import kafka.clients.consumer.NoOffsetForPartitionException;
import kafka.clients.consumer.OffsetAndTimestamp;
import kafka.clients.consumer.OffsetOutOfRangeException;
...
import kafka.common.errors.InvalidMetadataException;
import kafka.common.errors.InvalidTopicException;
import kafka.common.errors.RetriableException;
import kafka.common.errors.SerializationException;
...
public class Fetcher<K, V> {
     ...
     * @throws kafka.clients.consumer.NoOffsetForPartitionException If no offset reset strategy is defined
     */
