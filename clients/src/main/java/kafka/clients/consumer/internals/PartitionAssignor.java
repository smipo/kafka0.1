 ...
 * {@link kafka.clients.consumer.KafkaConsumer}. Members of the consumer group subscribe
...
public interface PartitionAssignor {
     ...
     * @param topics Topics subscribed to through {@link kafka.clients.consumer.KafkaConsumer#subscribe(java.util.Collection)}
     *               and variants
