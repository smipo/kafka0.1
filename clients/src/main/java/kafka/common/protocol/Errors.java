...
import kafka.common.errors.BrokerNotAvailableException;
import kafka.common.errors.ClusterAuthorizationException;
import kafka.common.errors.ControllerMovedException;
import kafka.common.errors.CorruptRecordException;
import kafka.common.errors.GroupAuthorizationException;
import kafka.common.errors.GroupCoordinatorNotAvailableException;
import kafka.common.errors.GroupLoadInProgressException;
import kafka.common.errors.IllegalGenerationException;
import kafka.common.errors.IllegalSaslStateException;
import kafka.common.errors.InconsistentGroupProtocolException;
import kafka.common.errors.InvalidCommitOffsetSizeException;
import kafka.common.errors.InvalidConfigurationException;
import kafka.common.errors.InvalidFetchSizeException;
import kafka.common.errors.InvalidGroupIdException;
import kafka.common.errors.InvalidPartitionsException;
import kafka.common.errors.InvalidReplicaAssignmentException;
import kafka.common.errors.InvalidReplicationFactorException;
import kafka.common.errors.InvalidRequestException;
import kafka.common.errors.InvalidRequiredAcksException;
import kafka.common.errors.InvalidSessionTimeoutException;
import kafka.common.errors.InvalidTimestampException;
import kafka.common.errors.InvalidTopicException;
import kafka.common.errors.LeaderNotAvailableException;
import kafka.common.errors.UnsupportedForMessageFormatException;
import kafka.common.errors.NetworkException;
import kafka.common.errors.NotControllerException;
import kafka.common.errors.NotCoordinatorForGroupException;
import kafka.common.errors.NotEnoughReplicasAfterAppendException;
import kafka.common.errors.NotEnoughReplicasException;
...
import kafka.common.errors.RebalanceInProgressException;
import kafka.common.errors.RecordBatchTooLargeException;
import kafka.common.errors.RecordTooLargeException;
import kafka.common.errors.ReplicaNotAvailableException;
import kafka.common.errors.RetriableException;
import kafka.common.errors.TopicExistsException;
import kafka.common.errors.UnsupportedSaslMechanismException;
import kafka.common.errors.TimeoutException;
import kafka.common.errors.TopicAuthorizationException;
import kafka.common.errors.UnsupportedVersionException;
import kafka.common.errors.UnknownMemberIdException;
