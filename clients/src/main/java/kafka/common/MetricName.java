...
public final class MetricName {
    ...
    /**
     * Please create MetricName by method {@link kafka.common.metrics.Metrics#metricName(String, String, String, Map)}
     *
     ...
     * Please create MetricName by method {@link kafka.common.metrics.Metrics#metricName(String, String, String, String...)}
     *
     * @param name          The name of the metric
     * @param group         logical group name of the metrics to which this metric belongs
     * @param description   A human-readable description to include in the metric
    ...
    /**
     * @deprecated This method will be removed in a future release.
     * Please create MetricName by method {@link kafka.common.metrics.Metrics#metricName(String, String, Map)}
     *
     * @param name  The name of the metric
     * @param group logical group name of the metrics to which this metric belongs
    ...
    /**
     * @deprecated This method will be removed in a future release.
     * Please create MetricName by method {@link kafka.common.metrics.Metrics#metricName(String, String, String)}
     *
     * @param name        The name of the metric
     * @param group       logical group name of the metrics to which this metric belongs
     * @param description A human-readable description to include in the metric
    ...
    /**
     * @deprecated This method will be removed in a future release.
     * Please create MetricName by method {@link kafka.common.metrics.Metrics#metricName(String, String)}
     *
     * @param name  The name of the metric
     * @param group logical group name of the metrics to which this metric belongs
     */
